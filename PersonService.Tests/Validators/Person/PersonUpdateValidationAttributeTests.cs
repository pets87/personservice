...
{
    [TestClass]
    public class PersonUpdateValidationAttributeTests
    {
        private PersonUpdateValidationAttribute attribute;

        [TestInitialize]
        public void SetUp()
        {
            attribute = new PersonUpdateValidationAttribute();
        }
        ...
        public void IsValid_ShouldReturnFalse_WhenIdIsNotSet()
        {
            ...
            Assert.IsFalse(result);
            Assert.AreEqual("Cannot update entity without Id", attribute.ErrorMessage);
        }
